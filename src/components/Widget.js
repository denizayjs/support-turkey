      ...
      <div className="container mx-auto space-y-12">
        <div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row">
          <div className="flex flex-col justify-center flex-1 p-6 dark:bg-gray-900">
            ...
            <p className="my-6 text-white border-gray-50 border-2 rounded py-8 px-16">{`${widgetCode}`}</p>
            <p className="my-6 dark:text-gray-400">For React.js and Next.js:</p>
            <p className="my-6 text-white border-gray-50 border-2 rounded py-8 px-16">{`${widgetCodeToReact}`}</p>
          </div>
        </div>
      </div>
    </section>
